...
class BaseZmqServer(CommsNode, ABC):
    ...
    def spin_send(self):
        ...
        print("Starting to send full state", flush=True)
    ...
    def spin_recv(self):
        ...
        while self.is_running():
            ...
            if action is not None:
                ...
                print("handled action", flush=True)
