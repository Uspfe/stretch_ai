...
class StretchClient(AbstractRobotClient):
    ...
    def __init__(
        ...
        # Interface modules
        print("creating StretchNavigationClient", flush=True)
        self.nav = StretchNavigationClient(self._ros_client, self._robot_model)
        print("creating StretchManipulationClient", flush=True)
        self.manip = StretchManipulationClient(self._ros_client, self._robot_model)
        print("creating StretchHeadClient", flush=True)
        ...
        print("switch to nav mode", flush=True)
    ...
    def move_to_manip_posture(self):
        ...
        print("Move manip command", flush=True)
        # self.switch_to_manipulation_mode()
    ...
    def move_to_nav_posture(self):
        ...
        print("move nav posture command", flush=True)
        # self.switch_to_manipulation_mode()
        ...
        # self.manip.goto_joint_positions(pos, head_pan=pan, head_tilt=tilt, blocking=True)
        self.switch_to_navigation_mode()
        self.nav.move_base_to([pos[0], 0, 0], relative=True)
    ...
    def head_to(
        ...
        """Send head commands"""
        print("move head to command", flush=True)
    ...
    def arm_to(
        ...
        """Send arm commands"""
        print("move arm to command", flush=True)
        # assert len(q) == 6
